...
#define MIN_X	0
#define MIN_Y	0
#define MAX_X	239 //319 //239
#define MAX_Y	319 //239 //319
...
public:
  ...
  //Added Landscape convenience functions:
  INT8U layoutMode;
  /*
  void setLayoutMode(INT8U mode);
  
  
  void drawString_landscape(char *string,INT16U poX, INT16U poY, INT16U size,INT16U fgcolor);
	void createChar_landscape( INT8U ascii, INT16U poX, INT16U poY,INT16U size, INT16U fgcolor);
	void fillRect_landscape(int x, int y, int w, int h, INT16U color);
	void drawRect_landscape(int x, int y, int w, int h, INT16U color);
	*/
