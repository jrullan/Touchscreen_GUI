/*************************************************** 
  ...
  MIT license, all text above must be included in any redistribution
	...
	* 
	* 2018-08-08 (jrullan): Modified for Touchscreen_GUI library
	* 	1. Inherits from Touch class
	* 	2. Defines the STMPE_CS (chip select) for Feather boards
	* 
 ****************************************************/
...
// STMPE_CS - Chip select when using SPI
#if defined(ESP32)
	#define STMPE_CS 32
...
#define STMPE_MINX 240
#define STMPE_MINY 240
#define STMPE_MAXX 3775 //corner closer to connector
#define STMPE_MAXY 3700 //corner closer to connector
...
// Added inheritance from Touch
class Adafruit_STMPE610 : public Touch
{
 public:
  ...
  //Required overrides for inheritance of Touch:
